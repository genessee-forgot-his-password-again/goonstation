...
/datum/manufacture/admingen/steel
	name = "Synthesized Steel Bar"
	item_outputs = list(/obj/item/material_piece/steel)
	item_requirements = list("metal" = 1)
	create = 1
	time = 1 SECONDS
	category = "Resource"

/datum/manufacture/admingen/copper
	name = "Synthesized Copper Bar"
	item_outputs = list(/obj/item/material_piece/copper)
	item_requirements = list("metal" = 1)
	create = 1
	time = 1 SECONDS
	category = "Resource"

/datum/manufacture/admingen/glass
	name = "Synthesized Glass Block"
	item_outputs = list(/obj/item/material_piece/glass)
	item_requirements = list("crystal" = 1)
	create = 1
	time = 1 SECONDS
	category = "Resource"

/datum/manufacture/admingen/standard_kit
	name = "First-aid Kit (Standard)"
	item_requirements = list("metal" = 1,
							 "crystal" = 1)
	item_outputs = list(/obj/item/storage/firstaid/regular)
	create = 1
	time = 5 SECONDS
	category = "Medicine"

/datum/manufacture/admingen/brute_kit
	name = "First-aid Kit (Brute)"
	item_requirements = list("metal" = 2,
							 "crystal" = 2)
	item_outputs = list(/obj/item/storage/firstaid/brute)
	create = 1
...
/datum/manufacture/admingen/burn_kit
	name = "First-aid Kit (Burn)"
	item_requirements = list("metal" = 2,
							 "crystal" = 2)
	item_outputs = list(/obj/item/storage/firstaid/fire)
	create = 1
...
/datum/manufacture/admingen/toxin_kit
	name = "First-aid Kit (Toxin)"
	item_requirements = list("metal" = 2,
							 "crystal" = 2)
	item_outputs = list(/obj/item/storage/firstaid/toxin)
	create = 1
	time = 10 SECONDS
	category = "Medicine"

/datum/manufacture/admingen/oxygen_kit
	name = "First-aid Kit (Oxygen Loss)"
	item_requirements = list("metal" = 2,
							 "crystal" = 2)
	item_outputs = list(/obj/item/storage/firstaid/oxygen)
	create = 1
	time = 10 SECONDS
	category = "Medicine"

/datum/manufacture/admingen/brain_kit
	name = "First-aid Kit (Neurological)"
	item_requirements = list("metal" = 5,
							 "crystal" = 5)
	item_outputs = list(/obj/item/storage/firstaid/brain)
	create = 1
	time = 15 SECONDS
	category = "Medicine"

/datum/manufacture/admingen/crit_kit
	name = "First-aid Kit (Critical Stabilization)"
	item_requirements = list("metal" = 5,
							 "crystal" = 5)
	item_outputs = list(/obj/item/storage/firstaid/crit)
	create = 1
...
/datum/manufacture/admingen/combat_knife
	name = "Combat Knife"
	item_requirements = list("metal" = 10)
	item_outputs = list(/obj/item/dagger/specialist)
	create = 1
	time = 10 SECONDS
	category = "Melee"