...
/obj/machinery/vending/adminfood
	...
	create_products()
		...
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/bottle/soda/bottledwater, 100)
		...
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/food/drinks/bottle/soda/orange, 100)
