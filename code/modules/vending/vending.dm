...
/obj/machinery/vending/adminguns
	...
	create_products()
		...
		product_list += new/datum/data/vending_product(/obj/item/gun/kinetic/faith/plain, 20, infinite = TRUE)
		product_list += new/datum/data/vending_product(/obj/item/gun/kinetic/drake, 20, infinite = TRUE)
		product_list += new/datum/data/vending_product(/obj/item/gun/kinetic/silenced_22, 20, infinite = TRUE)
		product_list += new/datum/data/vending_product(/obj/item/gun/kinetic/capella, 20, infinite = TRUE)
		product_list += new/datum/data/vending_product(/obj/item/gun/kinetic/survival_rifle, 20, infinite = TRUE)
		...
		product_list += new/datum/data/vending_product(/obj/item/ammo/bullets/bullet_22match, 20, infinite = TRUE)
		...
		product_list += new/datum/data/vending_product(/obj/item/crashaxe, 20, infinite = TRUE)
